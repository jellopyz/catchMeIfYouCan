...
public class Chapter1 implements Screen{
	...
	public Texture grid, img_shoe, img_banana, img_bananapeel;
	...
	public void handle(float delta) {
		...
		//banana
		if (player1.rect.overlaps(banana.rect)) {
			banana.rect.x += 100000;
			player1.holding = "Banana";
			banana.peel = true;
			
		}
		if (player2.rect.overlaps(banana.rect)) {
			banana.rect.x += 100000;
		...
		if (player1.holding == "Banana") {
			if (Gdx.input.isKeyPressed(Input.Keys.NUMPAD_0) && player1.prevkey == "UP"){
				banana.rect.x = player1.topbox.x;
				banana.rect.y = player1.topbox.y;
			}
			else if (Gdx.input.isKeyPressed(Input.Keys.NUMPAD_0) && player1.prevkey == "DOWN"){
				banana.rect.x = player1.downbox.x;
				banana.rect.y = player1.downbox.y;
			}
			else if (Gdx.input.isKeyPressed(Input.Keys.NUMPAD_0) && player1.prevkey == "RIGHT"){
				banana.rect.x = player1.rightbox.x;
				banana.rect.y = player1.rightbox.y;
			}
			else if (Gdx.input.isKeyPressed(Input.Keys.NUMPAD_0) && player1.prevkey == "LEFT"){
